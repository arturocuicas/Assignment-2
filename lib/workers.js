...
workers.validateCheckData = (originalCheckData) => {
  ...
  originalCheckData.userEmail = typeof(originalCheckData.userEmail) == 'string' && originalCheckData.userEmail.trim().length == 10 ? originalCheckData.userEmail.trim() : false;
